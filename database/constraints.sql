-- CONSTRAINTS.SQL: Thêm khóa ngoại và các ràng buộc CHECK
...
ALTER TABLE drivers
    ...
    ADD CONSTRAINT chk_drivers_status CHECK (status IN ('working', 'inactive'));
...
ALTER TABLE trip_logs
    ...
    ADD CONSTRAINT chk_logs_status CHECK (status IN ('completed', 'cancelled'));
...
ALTER TABLE incident_reports
    ...
    ADD CONSTRAINT chk_incident_status CHECK (status IN ('pending', 'resolved'));
