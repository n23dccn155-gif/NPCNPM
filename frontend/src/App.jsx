    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/dispatcher/auto-scheduler" element={<PrivateRoute allowedRoles={['dispatcher']}><AutoSchedulerPage /></PrivateRoute>} />
          ...
          <Route path="/dispatcher/route-buses" element={<PrivateRoute allowedRoles={['dispatcher']}><RouteBusManage /></PrivateRoute>} />
          <Route path="/dispatcher/route-drivers" element={<PrivateRoute allowedRoles={['dispatcher']}><RouteDriverManage /></PrivateRoute>} />
